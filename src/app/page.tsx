  ...
  return (
    <main className="flex min-h-screen w-full flex-col px-16">
      <div className="flex justify-center min-h-screen">
        <div className="flex justify-center border-20 rounded-4xl border-neutral-900 w-full m-10 bg-[radial-gradient(#ffffff08_0.1px,transparent_1px)] bg-size-[6px_6px]">
          <Board />
        </div>
